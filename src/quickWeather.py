...
url = f'http://api.openweathermap.org/data/2.5/forecast?q={location}&cnt=3&appid={credenciais.chave_api}&units=metric&lang=pt_br'
...
def enviar_telegram(mensagem):
    token = credenciais.telegram_token
    chat_id = credenciais.telegram_id
